...
Read project profile, lifecycle.md and delivery.md. Call helper inbox; reconcile unfinished owned finalization. If change not explicitly selected, show ready candidates/dependencies and ask which to take, even if only one. Offer related quick batches; preserve individual IDs. Do not begin blocked, paused or initiative-only work as application implementation.
